...
//xcrmqifgghjkbdbh
		try {
			...
			props.put("username", "15849994576@163.com");
			props.put("password", "zhaoyu666");
			...
			msg.setFrom(new InternetAddress("15849994576@163.com"));
			msg.addRecipients(Message.RecipientType.TO,
					InternetAddress.parse(to));
			msg.setSubject("激活邮件");
			msg.setContent(
					"<p>重置密码为<strong>admin123</strong><br/>请重新登录: 任意门---<a href='http://localhost:8080/shop/view/admin/index.html' style='text-decoration: none;'>橙汁儿,后台管理系统</a></p>", "text/html;charset=UTF-8");
			msg.saveChanges();
...
//		sendMail("804998302@qq.com", "zhaoyu");
//	}
}
