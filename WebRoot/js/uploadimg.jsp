...
<LINK 
href="/zyglsys/admin/images/syscome.files/Admin.css" rel=stylesheet>
<SCRIPT language=javascript src="/zyglsys/admin/images/syscome.files/Admin.js"></SCRIPT>
<script type="text/javascript" src="/zyglsys/js/popup.js"></script>
...
if(filename!=null)
{
 ...
 <%} %>
<form action="/zyglsys/zyglsys?ac=uploadimg" enctype="multipart/form-data" name="f1" method="post">
...
if(suc!=null)
{
 %>
 alert("操作成功");
  parent.location.replace("/zyglsys/admin/kcfiles.jsp");
 <%}%>
 </script>
