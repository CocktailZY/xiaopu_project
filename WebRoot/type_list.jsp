...
<tr>
						 ...
						 <td align="center"><%=alRow.get(1)%></td> 
								<td align="center" width="25%">
									  <a href="<%=path%>/editType.jsp?id=<%=alRow.get(0)%>" class="admin">编辑</a> &nbsp;
									<a href="<%=path%>/TypeServlet?method=delete&id=<%=alRow.get(0)%>"
										class="admin">删除</a>
								</td>
							</tr>
							<%
							...
							<tr class="tabletop">
								...
								<td colspan="6" align="center">
									...
									for (int i = 0; i < Math.ceil(products.size()
											...
											if (pages == (i + 1)) {
								%>
									<a href="<%=path%>/type_list.jsp?pages=<%=i + 1%>"><font
										color="red"><%=i + 1%></font> </a>&nbsp;
									<%
										} else {
									%>
									<a href="<%=path%>/type_list.jsp?pages=<%=i + 1%>"><%=i + 1%></a>&nbsp;
