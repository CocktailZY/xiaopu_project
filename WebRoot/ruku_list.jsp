				...
				<td class="border_left border_right border_bottom" height="400"
					...
					<form name="form1" method="post"
						...
						<table width="100%" border="0" cellspacing="1" cellpadding="3">
						 ...
						 <td align="center"><%=alRow.get(15)%></td>  
						   
								<td align="center" width="25%">
									 
									<a href="<%=path%>/RukuServlet?method=delete&id=<%=alRow.get(0)%>"
										class="admin">删除</a>
								</td>
							</tr>
							<%
							...
							<tr class="tabletop">
								...
								<td colspan="17" align="center">
									...
									for (int i = 0; i < Math.ceil(products.size()
											...
											if (pages == (i + 1)) {
								%>
									<a href="<%=path%>/ruku_list.jsp?pages=<%=i + 1%>"><font
										color="red"><%=i + 1%></font> </a>&nbsp;
									<%
										} else {
									%>
									<a href="<%=path%>/ruku_list.jsp?pages=<%=i + 1%>"><%=i + 1%></a>&nbsp;
