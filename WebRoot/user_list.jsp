...
String biaoqian=request.getParameter("biaoqian");
						 ...
						 <td align="center"><%=alRow.get(12)%></td>  
								...
								<td align="center" width="25%">
									   <a href="<%=path%>/editUser.jsp?id=<%=alRow.get(0)%>"
										class="admin">编辑</a> &nbsp;
									<a href="<%=path%>/UserServlet?method=delete&id=<%=alRow.get(0)%>"
										class="admin">删除</a>
								</td>
							</tr>
							<%
							...
							<tr class="tabletop">
								...
								<td colspan="14" align="center">
									...
									for (int i = 0; i < Math.ceil(products.size()
											...
											if (pages == (i + 1)) {
								%>
									<a href="<%=path%>/user_list.jsp?pages=<%=i + 1%>"><font
										color="red"><%=i + 1%></font> </a>&nbsp;
									<%
										} else {
									%>
									<a href="<%=path%>/user_list.jsp?pages=<%=i + 1%>"><%=i + 1%></a>&nbsp;
