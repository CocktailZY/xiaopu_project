			...
			<tr>
				<td class="border_left border_right border_bottom" height="400"
					...
					<div id="formwrapper">
						...
						<form action="<%=path%>/GoodsServlet?method=update&id=<%=id %>" method="post"
							...
							<fieldset>
								...
								<div>
									...
									<input type="text" class="it1" onBlur="this.className='it1';"
										...
										value="<%=new AllBean().getgoods(id).get(1).toString() %>"
								...
								<div>
									...
									<input type="text" class="it1" onBlur="this.className='it1';"
										style="WIDTH: 160px; FONT-FAMILY: Arial"
										value="<%=new AllBean().getgoods(id).get(2).toString() %>"
								...
								<div>
									...
									<input type="text" class="it1" onBlur="this.className='it1';"
										style="WIDTH: 160px; FONT-FAMILY: Arial"
										value="<%=new AllBean().getgoods(id).get(3).toString() %>"
								...
								<div>
									...
									<input type="text" class="it1" onBlur="this.className='it1';"
										style="WIDTH: 160px; FONT-FAMILY: Arial"
										value="<%=new AllBean().getgoods(id).get(5).toString() %>"
								...
								<div>
									...
									<input type="text" class="it1" onBlur="this.className='it1';"
										style="WIDTH: 160px; FONT-FAMILY: Arial"
										value="<%=new AllBean().getgoods(id).get(6).toString() %>"
								...
								<div>
									...
									<input type="text" class="it1" onBlur="this.className='it1';"
										style="WIDTH: 160px; FONT-FAMILY: Arial"
										value="<%=new AllBean().getgoods(id).get(8).toString() %>"
										onFocus="this.className='it2';" name="weizhi">
									<br />
								</div>
								<div>
									<label for="name">
									...
									<input type="text" class="it1" onBlur="this.className='it1';"
										style="WIDTH: 160px; FONT-FAMILY: Arial"
										value="<%=new AllBean().getgoods(id).get(9).toString() %>"
										onFocus="this.className='it2';" name="num">
									<br />
								</div>
								<div>
									<label for="name">
									...
									<input type="text" class="it1" onBlur="this.className='it1';"
										style="WIDTH: 160px; FONT-FAMILY: Arial"
										value="<%=new AllBean().getgoods(id).get(10).toString() %>"
