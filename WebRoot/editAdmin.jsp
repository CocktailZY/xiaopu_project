			...
			<tr>
				<td class="border_left border_right border_bottom" height="400"
					...
					<div id="formwrapper">
						...
						<form action="<%=path%>/AdminServlet?method=update" method="post"
							 ...
							 <input type="hidden" name="id" value="<%=id %>" />
								...
								<div>
									...
									<input type="text" class="it1" onBlur="this.className='it1';"
										...
										value="<%=new AllBean().getAdmin(id).get(1).toString() %>"
										onFocus="this.className='it2';" name="account">
									<br />
								</div>
								 	<div>
									<label for="name">
									...
									<input type="text" class="it1" onBlur="this.className='it1';"
										style="WIDTH: 160px; FONT-FAMILY: Arial"
										value="<%=new AllBean().getAdmin(id).get(2).toString() %>"
										
										onFocus="this.className='it2';" name="pwd">
									<br />
								</div>
							 
							 	 	 
								<div class="enter">
									<input type="submit" class="buttom" value="更新" />
