...
<body>
	...
	<div class="card-page">
		<div class="container">
			...
			<div class="header-logo">
					<h1>
						<a><span>客官购物车为空哦！点击下面</span><i></i></a>
					</h1>
				</div>
			...
			<div class="col-md-2">
				...
				<form action="<%=basePath%>/view/product/products1.jsp">
				<input type="submit" value="去购物" style="background: coral;width:150px; height: 60px" style="border-style:solid;" style="color:black"/>
				</form>
				</div>
			</div>
		</div>
