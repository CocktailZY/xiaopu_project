...
<body>
			...
			<div class="container">
				...
				<div class="container">
					<div class="header-search">
						<form action="<%=basePath %>product/getAllProductByPage.do" method="post" id="searchForm">
	...
	<div class="products">
		<div class="container">
			...
			<form action="product/getAllProductByPage.do" method="post" id="findFrom">
				<input type="hidden" id="pageNum" name="pageNum">
				
				<c:forEach items="${generalList }" var="g" >
