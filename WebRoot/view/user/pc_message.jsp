...
<link href="<%=basePath%>css/personalcenter.css" rel="stylesheet" type="text/css" media="all" /> 
<!-- //Custom Theme files -->
<!-- font-awesome icons -->
...
<body>
	...
	<div class="w3l-services">
		<div class="container"> 
			...
			<script type="text/javascript">
				function head1(){
					document.getElementById("heaDisplay").style.display = "block";
				}
				function head2(){
					document.getElementById("heaDisplay").style.display = "none";
				}
				function bbb() {
			...
			<div class="row">
				<div class="col-md-2">
					<form id="fm1" action="<%=basePath%>user/changeHead.do" method="post" enctype="multipart/form-data">
					<div style="width: 150px;height: 150px;background-color: #008654;position:relative;">
						<img src="<%=basePath%>fileUpload/${loginUser.uHead}" onmouseover="head1()" onmouseout="head2()">
						<div id="heaDisplay" class="div-head"  >
							<a href="javascript:bbb()" onmouseover="head1()" onmouseout="head2()" style="color:white;">编辑图片</a>
							<input type="file" id="head" name="hf" style="position: absolute; filter: alpha(opacity = 0); opacity: 0;"onchange="aaa()">
						</div>
					</div>
					</form>
				</div>
				...
				<div class="col-md-10">
					<div style="margin-left: 5%;">
						<div>
							<div class="pcmtitle" style="display: inline;">账号信息</div>
							<div class="pcmtitle" style="display: inline;margin-left: 85%;">编辑</div>
						</div>
						<p style="border-bottom-style: solid;border-color: #000000;border-bottom-width: 1px;margin-bottom: 10px;margin-top: 10px;"></p>
						<p class="pcm">用&nbsp;户&nbsp;名：&nbsp;&nbsp;<span>${loginUser.uName}</span></p>
						<p class="pcm">真实姓名</p>
						<p class="pcm">密&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;码&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="#" ><span>修改</span></a></p>
					</div>
					<div style="margin-left: 5%;">
						<div>
							<div class="pcmtitle" style="display: inline;">等级信息</div>
							
						</div>
						<p style="border-bottom-style: solid;border-color: #000000;border-bottom-width: 1px;margin-bottom: 10px;margin-top: 10px;"></p>
						<p class="pcm">当前积分:${loginUser.uName}</p>
						<p class="pcm">当前等级</p>
						<p class="pcm">等级经验</p>
						<div class="progress">
					...
					<div style="margin-left: 5%;">
						<div>
							<div class="pcmtitle" style="display: inline;">邮箱验证</div>
						</div>
						<p style="border-bottom-style: solid;border-color: #000000;border-bottom-width: 1px;margin-bottom: 10px;margin-top: 10px;"></p>
						<p class="pcm">邮箱验证</p>
