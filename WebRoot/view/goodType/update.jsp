...
<div align="center">
	...
	<table border="1" class="tablelist">
		<form id="myForm" action="<%=request.getContextPath() %>/goodType/save.action" method="post">
		<input type="hidden" name="dto.id" value="${dto.id }">
			<tr>
				<td>类型名称</td>
				<td><input type="text" name="dto.typeName" value="${dto.typeName }" class="my_input"></td>
			</tr>
