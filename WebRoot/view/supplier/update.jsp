...
<div align="center">
	...
	<table border="1" class="tablelist">
		...
		<input type="hidden" name="dto.id" value="${dto.id }">
			<tr>
				<td>供应商名称</td>
				<td><input type="text" name="dto.supName" value="${dto.supName }" class="my_input"></td>
			</tr>
			<tr>
				<td>联系电话</td>
				<td><input type="text" name="dto.tel" value="${dto.tel }" class="my_input"></td>
			</tr>
			<tr>
				<td>联系地址</td>
				<td><input type="text" name="dto.address" value="${dto.address }" class="my_input"></td>
			</tr>
