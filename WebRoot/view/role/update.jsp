...
<div align="center">
	<div class="uew-select" style="padding-top: 9px; padding-bottom: 9px; text-align: left;">
		<a href="<%=request.getContextPath()%>/role/list.action" class="my_a">返回</a>
	</div>
	<table border="1" class="tablelist">
		<form id="myForm" action="<%=request.getContextPath() %>/role/save.action" method="post">
			<tr>
				<td>名称</td>
				<td>
					<input type="text" name="dto.role_name" value="${dto.role_name }" class="my_input">
