...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="<%=basePath %>view/admin/admin.jsp" title="Go to Home" class="tip-bottom"><i class="icon-home"></i>首 页</a> <a href="#" class="current">商品类型管理</a> </div>
  </div>
    ...
    <div class="row-fluid">
      <div class="span12">
        <div class="widget-box">
          ...
          <form action="<%=basePath%>productType/save.do" method="post">
	            <table class="table table-bordered data-table">
	              <tbody>
	              	...
	              	<tr>
	              		...
	              		<td>
		              		<select name="type" id="typeId" onchange="set_fpower(this)">
								<option value="1" selected="selected">一级类型</option>
								<option value="2">二级类型</option>
								<option value="3">三级类型</option>
							</select>
	              		</td>
		...
		$.ajax({
			...
			success:function(data){
				...
				for(var i=0;i<json.length;i++){
					if(json[i].ptId != null){
						var td = ("<option value="+json[i].ptId+">"+json[i].ptName+"</option>"); 
						row2.append(td);
					}
				}
	        },
			...
			if(id==3){
				...
				$.ajax({
					...
					async:true,
					dataType:"json",
					url:"<%=basePath%>productType/listSecond.do",
					data:{
						type:2
					},
					success:function(data){
