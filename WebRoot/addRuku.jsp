			...
			<tr>
				<td class="border_left border_right border_bottom" height="400"
					...
					<div id="formwrapper">
						...
						<form action="<%=path%>/RukuServlet?method=insert"
							...
							商品入库
								...
								<select name="rukuType"  style="width:160px" size="1">
								...
								<div style="display: none;"  >
									...
									<input type="text" class="it1" onBlur="this.className='it1';"
										...
										onFocus="this.className='it2';" name="rukuNo">
									<br />
								</div>
								<div>
									<label for="name">
									...
									<input type="text" class="Wdate" style="width: 160px"
										...
										name="rukuriqi" value="<%=Utils.getCurDate() + ""%>" />
									<br />
								</div>
								...
								<div>
									...
									<%
										...
										List<HashMap> list1 = dao1.select("select * from t_gongyingshang  ");
									%>
									<select name="gongyingshang" style="width: 160px">
										<%
